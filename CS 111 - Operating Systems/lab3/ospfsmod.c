...
//
//   TODO: Make sure that deleting symbolic links works correctly.
...
ospfs_unlink(struct inode *dirino, struct dentry *dentry)
{
	...
	if (oi->oi_ftype != OSPFS_FTYPE_SYMLINK && oi->oi_nlink == 0) return change_size(oi, 0);
...
//
// DONE-CHECK: Write this function.
