...
@tests = (
	...
	# --------------------
	# create symbolic links, both point to same thing
	[ 'cd test && ln -s world.txt w.txt && diff world.txt w.txt && rm w.txt',
	''
	],

	# create hard links, both point to same thing
	[ 'ln test/world.txt test/x.txt && diff test/world.txt test/x.txt && rm test/x.txt',
	''
	],

	# hard and symbolic links both point to same thing
	['cd test && ln -s world.txt w.txt && ln world.txt x.txt && diff x.txt w.txt && rm x.txt w.txt',
	''
	],
