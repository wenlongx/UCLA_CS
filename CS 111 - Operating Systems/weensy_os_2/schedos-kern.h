...
typedef struct process {
	...
	int p_priority;		// for EXERCISE 4A
	int p_share;		// for EXERCISE 4B
	int p_share_completed;	// for EXERCISE 4B
	int p_lots;			// for EXERCISE 7
} process_t;

// EXERCISE 8 code
// 0 when unlocked, 1 when acquired by a process
int writelock;
